                ...
                <div class="card shadow-sm border-0">
                    ...
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div class="author-info d-flex align-items-center gap-2">
                                ...
                                <div>
                                    ...
                                    <div class="review-stars mt-1">
                                        @for($i = 1; $i <= 5; $i++)
                                            <span
                                                class="star {{ $i <= $viewData['review']->getRating() ? 'filled' : 'empty' }}">★</span>
                                        @endfor
                            ...
                            <div class="date-info text-end">
                                <small class="text-muted d-block">
                                    <i class="bi bi-calendar"></i> {{ __('reviews.created') }}:
                                    {{ $viewData['review']->getCreatedAt() }}
                                </small>
                                @if($viewData['review']->getCreatedAt() != $viewData['review']->getUpdatedAt())
                                    <small class="text-muted">
                                        <i class="bi bi-pencil"></i> {{ __('reviews.updated') }}:
                                        {{ $viewData['review']->getUpdatedAt() }}
                                    </small>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between mt-4 pt-3 border-top">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                @if(Auth::check() && (Auth::user()->getRole() === 'admin' || Auth::id() === $viewData['review']->getUserId()))
                                    <button type="button" class="btn btn-outline-danger" data-toggle-modal="delete-confirm">
                        ...
                        <div id="delete-confirm" class="alert alert-danger mt-4 d-none text-center">
                            ...
                            <form
                                action="{{ route('review.delete', ['productId' => $viewData['product']->getId(), 'reviewId' => $viewData['review']->getId()]) }}"
                            ...
                            <button class="btn btn-secondary" data-close-modal="delete-confirm">
